<!DOCTYPE html>
<html lang="en">
<title>Lugnut's Automotive Parts Supply - Login</title>
<head>
...
<div class="clearboth"></div>	<div class="heading">
	...
	<h1><strong>Please Login or Register Before Purchasing Products</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h1>
	<div class="clearboth"></div>
	</div>	
        ...
        <br>
        <br> 	
        <button class="btn btn-success" type="submit">Log In</button>&nbsp;&nbsp; | &nbsp;&nbsp;<a class="btn btn-primary2" href="register.php">Sign Up</a>
      </form>
      </div>
