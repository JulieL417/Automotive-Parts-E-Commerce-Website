<!DOCTYPE html>
<html lang="en">
<title>Lugnut's Automotive Parts Supply - Shop with us today for great savings!</title>
<head>
...
<div class="clearboth"></div><div id="SlideShow_1_lit" class="outerdivtext"></div>
<div class="slider">
	<ul>
		<li>
			<a href="category.php?id=1">
				<img src="Banners/air and fuel banner.jpg" id="SlideShow_1_rptSlideShow_ct100_SlideImage" width="1000" height="380" alt="Slide Show">
			</a>
		</li>
		<li>     
			<a href="category.php?id=2">
				<img src="Banners/brake systems banner.jpg" id="SlideShow_1_rptSlideShow_ct101_SlideImage" width="1000" height="380" alt="Slide Show">
			</a>
		</li>
        <li>
            <a href="category.php?id=3">
            	<img src="Banners/chassis banner.jpg" id="SlideShow_1_rptSlideShow_ct102_SlideImage" width="1000" height="380" alt="Slide Show">
            </a>
        </li>
        <li>
            <a href="category.php?id=4">
            	<img src="Banners/cooling and heating.jpg" id="SlideShow_1_rptSlideShow_ct103_SlideImage" width="1000" height="380" alt="Slide Show">
            </a>
        </li>
        <li>
            <a href="category.php?id=5">
            	<img src="Banners/engine banner.jpg" id="SlideShow_1_rptSlideShow_ct104_SlideImage" width="1000" height="380" alt="Slide Show">
            </a>
        </li>
        <li>
            <a href="category.php?id=6">
            	<img src="Banners/exhaust banner.jpg" id="SlideShow_1_rptSlideShow_ct105_SlideImage" width="1000" height="380" alt="Slide Show">
            </a>
        </li>
</ul>
<div class="dots"></div>
...
<div class="heading">
	...
	<ul>
			...
			<div class="low_price">
				...
				<p>
					<label><span id="SectionProductScroll1_rptSlide_ct100_lblUnStrikedPrice" class="pro_size">
                    		<span class="LabelText StrikeThrough">Price: </span>
                            <span class="NormalText StrikeThrough">$100.00</span>
                            </span>
                    </label>
				</p>
			</div>
			...
			<div class="low_price">
				...
				<p>
					<label><span id="SectionProductScroll1_rptSlide_ct100_lblUnStrikedPrice" class="pro_size">
                    		<span class="LabelText StrikeThrough">Price: </span>
                            <span class="NormalText StrikeThrough">$500.00</span>
                            </span>
                    </label>
				</p>
			</div>
        		...
        		<li>
			<img id="SectionProductScroll1_rptSlide_ctl00_imgProductSectionIcon" hspace="0" vspace="0" border="0" style="border-width:0px;display: none;" alt="featuredProducts">
			<a href="product.php?id=11" id="SectionProductScroll1_rptSlide_ctl00_hprlnkimgProduct" class="links">
				<img src="img/grey.gif" id="Product" alt="image" height="230" width="230" class="lazy" data-original="Auto Parts Images/360 pixel Images/BrakeCooling360.jpg">
			</a>
			<div class="low_price">
				<h4><a href="product.php?id=11">Brake Cooling Kit</a></h4>
				<p>
					<label><span id="SectionProductScroll1_rptSlide_ct100_lblUnStrikedPrice" class="pro_size">
                    		<span class="LabelText StrikeThrough">Price: </span>
                            <span class="NormalText StrikeThrough">$150.00</span>
                            </span>
                    </label>
				</p>
			</div>
        		...
        		<li>
			<img id="SectionProductScroll1_rptSlide_ctl00_imgProductSectionIcon" hspace="0" vspace="0" border="0" style="border-width:0px;display: none;" alt="featuredProducts">
			<a href="product.php?id=20" id="SectionProductScroll1_rptSlide_ctl00_hprlnkimgProduct" class="links">
				<img src="img/grey.gif" id="Product" alt="image" height="230" width="230" class="lazy" data-original="Auto Parts Images/360 pixel Images/ChassisComponent360.jpg">
			</a>
			<div class="low_price">
				<h4><a href="product.php?id=20">Chassis Component</a></h4>
				<p>
					<label><span id="SectionProductScroll1_rptSlide_ct100_lblUnStrikedPrice" class="pro_size">
                    		<span class="LabelText StrikeThrough">Price: </span>
                            <span class="NormalText StrikeThrough">$35.00</span>
                            </span>
                    </label>
				</p>
			</div>
        		...
        		<li>
			<img id="SectionProductScroll1_rptSlide_ctl00_imgProductSectionIcon" hspace="0" vspace="0" border="0" style="border-width:0px;display: none;" alt="featuredProducts">
			<a href="product.php?id=24" id="SectionProductScroll1_rptSlide_ctl00_hprlnkimgProduct" class="links">
				<img src="img/grey.gif" id="Product" alt="image" height="230" width="230" class="lazy" data-original="Auto Parts Images/360 pixel Images/Fan360.jpg">
			</a>
			<div class="low_price">
				<h4><a href="product.php?id=24">Fans</a></h4>
				<p>
					<label><span id="SectionProductScroll1_rptSlide_ct100_lblUnStrikedPrice" class="pro_size">
                    		<span class="LabelText StrikeThrough">Price: </span>
                            <span class="NormalText StrikeThrough">$150.00</span>
        		...
        		<li>
			<img id="SectionProductScroll1_rptSlide_ctl00_imgProductSectionIcon" hspace="0" vspace="0" border="0" style="border-width:0px;display: none;" alt="featuredProducts">
			<a href="product.php?id=42" id="SectionProductScroll1_rptSlide_ctl00_hprlnkimgProduct" class="links">
				<img src="img/grey.gif" id="Product" alt="image" height="230" width="230" class="lazy" data-original="Auto Parts Images/360 pixel Images/Clamp360.jpg">
			</a>
			<div class="low_price">
				<h4><a href="product.php?id=42">Clamp</a></h4>
				<p>
					<label><span id="SectionProductScroll1_rptSlide_ct100_lblUnStrikedPrice" class="pro_size">
                    		<span class="LabelText StrikeThrough">Price: </span>
                            <span class="NormalText StrikeThrough">$4.00</span>
                            </span>
                    </label>
				</p>
			</div>
